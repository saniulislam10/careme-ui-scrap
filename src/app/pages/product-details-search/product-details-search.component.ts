...
import { DialogBoxComponent } from 'src/app/shared/dialog-view/dialog-box/dialog-box.component';
...
export class ProductDetailsSearchComponent implements OnInit, OnDestroy {
  ...
  shippingToggle(){
    this.shippingBtn =! this.shippingBtn;
    this.descriptionBtn = false;
    this.reviewBtn = false;
  }
  reviewToggle(){
