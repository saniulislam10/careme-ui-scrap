...
import {ProductDetailsRoutingModule} from './product-details-search-routing.module';
...
@NgModule({
  declarations: [ProductDetailsSearchComponent, RatingAndReviewComponent, DiscussionFormComponent, DiscussionItemComponent, DiscussionReplyItemComponent],
    imports: [
        CommonModule,
